...
export const COOKIE_SESSAO = "encanto_painel";

const SENHA_LOCAL = process.env.PAINEL_SENHA_LOCAL ?? "encanto";
const SEGREDO = process.env.PAINEL_SEGREDO ?? "encanto-desenvolvimento";
