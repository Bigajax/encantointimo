...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: r.nome,
    description: `${r.nome} na Encanto Íntimo: ${quantas} ${quantas === 1 ? "peça" : "peças"}. Pedido pelo WhatsApp.`,
  ...
  return (
    <>
      <header className="miolo pb-6 pt-8 lg:pb-8 lg:pt-12">
        <h1 className="manchete text-[clamp(2rem,4.5vw,3rem)] text-tinta">{r.nome}</h1>
        <p className="voz mt-2 text-[1.25rem] text-agua">
          {quantas} {quantas === 1 ? "peça" : "peças"}. Tamanho e valor você combina na mensagem.
        </p>
      </header>
