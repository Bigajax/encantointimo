    ...
    <header className="relative z-50 [overflow-x:clip]">
      ...
      <div className="bg-branco text-marinho">
        <div className="miolo flex h-[4.25rem] items-center justify-between gap-3 lg:grid lg:h-[5.5rem] lg:grid-cols-[auto_minmax(0,1fr)_auto] lg:gap-10">
          ...
          <Link href="/" aria-label="Encanto Íntimo, página inicial" className="flex shrink-0">
            <span className="lg:hidden"><Logo altura={44} /></span>
            <span className="hidden lg:inline-flex"><Logo altura={62} /></span>
          </Link>

          <form onSubmit={buscar} role="search" className="mx-auto hidden w-full max-w-[32rem] lg:block">
            {busca("busca-topo", "O que você procura? Short doll, renda, body splash...")}
          </form>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <a href={linkWhats} target="_blank" rel="noreferrer" aria-label="Pedir no WhatsApp" className="flex h-10 w-10 items-center justify-center text-raia lg:hidden">
      ...
      <Link href="/#pedido" className="escuro flex items-center gap-2 px-[var(--sangria)] py-2.5 text-[0.8125rem] text-branco lg:hidden">
        <Icone nome="caminhao" className="h-4 w-4 shrink-0 text-raia" peso={1.8} />
        <span className="min-w-0 flex-1 truncate">
          <span className="font-semibold">Entrega em Itaporanga e região</span>
          <span className="text-marfim-fraco">, pedido pelo WhatsApp</span>
        </span>
